      ...
      <main>
        ...
        <div className="relative isolate overflow-hidden bg-gray-900 pb-16 pt-14 sm:pb-20">
          <img
            ...
            src="https://img.freepik.com/free-photo/cinematic-style-mall_23-2151551173.jpg?t=st=1745341211~exp=1745344811~hmac=eb338da1dafff65bbcf88618f9b823ef70b734b52d916070959728d888022f0c&w=996"
            className="absolute blur-xs -top-10 inset-0 -z-10 h-full w-full object-cover "
          />
          <div
            aria-hidden="true"
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
              <div className="hidden sm:mb-8 sm:flex sm:justify-center">
                <div className="relative rounded-full px-3 py-1 text-sm leading-6 bg-white/90 text-gray-700 ring-1 ring-white/10 hover:ring-white/20">
                Premium fabrics. Exceptional designs. Made for you.{' '}
              ...
              <div className="text-center">
                ...
                From bold statements to timeless classics — find the perfect outfit for every story you’re living.                </p>
        ...
        <div className="relative flex space-x-2 py-2 items-center z-10 rounded-full bg-zinc-950  px-4 ring-1 ring-white/10 ">
